  ...
  if (isSubmitted) {
    return (
        <div className="text-center py-12 flex flex-col items-center">
            ...
            <p className="text-muted-foreground mt-2 max-w-sm">Your appointment request has been submitted. We'll confirm via email and on your dashboard shortly.</p>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField control={form.control} name="topic" render={({ field }) => (
              <FormItem><FormLabel>Discussion Topic</FormLabel>
                <FormControl><Textarea placeholder="e.g., 'I have a question about my proof of funds documents.'" {...field} /></FormControl>
                <FormDescription>Briefly describe what you'd like to discuss.</FormDescription>
                <FormMessage />
              </FormItem>
            )} />
...
const UpgradePrompt = () => (
    <Card className="text-center overflow-hidden">
        <div className="bg-primary/10 py-8">
             <div className="mx-auto bg-primary text-primary-foreground p-4 rounded-full w-fit"><Rocket className="h-10 w-10" /></div>
        </div>
        <CardHeader className="pt-6">
            <CardTitle>Unlock 1-on-1 Consultations</CardTitle>
    ...
    <AppLayout>
      <main className="flex-1 space-y-6 p-4 md:p-8">
        <div>
          ...
          <p className="text-muted-foreground">Get expert advice from our immigration specialists.</p>
        </div>
        <AppointmentsContent />
      </main>
    </AppLayout>
